...
<body>
<%@page import="com.javapoint.bean.*,java.util.*"%>  
...
<td><a href="lab2_editform.jsp?id=${u.getId()}">Edit</a></td>  
<td><a href="lab2_deleteuser.jsp?id=${u.getId()}">Delete</a></td></tr>  
</c:forEach>  
</table>  
<br/><a href="lab2_adduserform.jsp">Add New User</a>  
